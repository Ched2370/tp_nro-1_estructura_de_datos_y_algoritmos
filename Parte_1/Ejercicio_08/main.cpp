...
nota final. Permita ingresar por teclado N, la cantidad de alumnos a calificar. Ejercicio 8: La calificación final de un estudiante es la media ponderada de tres notas: la nota de prácticas que 
cuenta un 30% del total, la nota teórica que cuenta un 60% y la nota de participación que cuenta el 10% restante. 
Escriba un programa que lea de la entrada estándar las tres notas de un alumno y escriba en la salida estándar su 
...
int main() {
    ...
    for (int i = 1; i <= cantAlums; ++i) {
        ...
        cout << "La nota final del alumno " << i << " es: " << fixed << setprecision(2) << notaFinal << endl;
    }
	return 0;
}
